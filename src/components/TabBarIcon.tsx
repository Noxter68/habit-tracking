/**
 * @file TabBarIcon.tsx
 * @description Icônes de la barre de navigation avec animations professionnelles.
 * Supporte l'animation heart bip et la couleur dynamique du tier utilisateur.
 */
...
interface TabBarIconProps {
  ...
  size?: number;
  /** Couleur du tier actuel de l'utilisateur */
  tierColor?: string;
...
export const TabBarIcon: React.FC<TabBarIconProps> = ({ name, color, focused, size = 24, tierColor, triggerPulse = false }) => {
  ...
  // Style animé pour l'icône (sans animation pulse)
