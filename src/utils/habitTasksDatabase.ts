...
export const HABIT_TASKS_DATABASE: CategoryTasksDefinition[] = [
  ...
  // PRODUCTIVITY
  {
    ...
    good: [
      ...
      { id: 'track-goals', icon: BarChart3, translationKey: 'track-goals' },
      { id: 'priority-task', icon: Star, translationKey: 'priority-task' },
    ],
    bad: [
      { id: 'no-emails-morning', icon: Mail, translationKey: 'no-emails-morning' },
      { id: 'no-phone-first-hour', icon: Smartphone, translationKey: 'no-phone-first-hour' },
      { id: 'limit-meetings', icon: Users, translationKey: 'limit-meetings' },
    ],
  },
  ...
  // MINDFULNESS
  {
    ...
    good: [
      { id: 'morning-meditation', icon: Stars, translationKey: 'morning-meditation' },
      { id: 'gratitude-practice', icon: Heart, translationKey: 'gratitude-practice' },
      { id: 'nature-walk', icon: Trees, translationKey: 'nature-walk' },
      { id: 'breathing-exercise', icon: Wind, translationKey: 'breathing-exercise' },
      { id: 'body-scan', icon: ScanFace, translationKey: 'body-scan' },
      { id: 'mindful-eating', icon: Eye, translationKey: 'mindful-eating' },
    ],
    bad: [
      { id: 'no-rushing', icon: Turtle, translationKey: 'no-rushing' },
      { id: 'limit-news', icon: Tv, translationKey: 'limit-news' },
      { id: 'no-worrying', icon: CloudSun, translationKey: 'no-worrying' },
    ],
  },
